...
module.exports = [
...

  {
    ...
    method: "GET",
    url: "https://graph.facebook.com/v23.0/{wabaId}/phone_numbers",
  },
  {
    key: "waba_full",
    label: "WABA — Detalhes Completos",
    method: "GET",
    url: "https://graph.facebook.com/v23.0/{wabaId}?fields=account_review_status,currency,timezone_id,message_template_namespace,ownership_type,on_behalf_of_business_info,health_status",
  },
  {
    key: "subscribed_apps",
  ...
  },
  {
    ...
    label: "Templates",
    method: "GET",
    url: "https://graph.facebook.com/v23.0/{wabaId}/message_templates",
  },
...

  {
    ...
    method: "GET",
    url: "https://graph.facebook.com/v23.0/{phone_number_id}?fields=display_phone_number,platform_type,account_mode,is_on_biz_app",
